<main x-data="{ showForm: false }">
    <x-jet-breadcrumbs-nav>
        <x-slot name="crumbs">
            ...
            <a href="{{ route('personal.module') }}" class="text-gray-600 dark:text-gray-200 hover:underline"> Personal </a>
        </x-slot>
    </x-jet-breadcrumbs-nav>
        ...
        <div class="mt-2">
            <div class="flex flex-col md:flex-row border-b border-gray-200 pb-4 mb-4">
                ...
                <div class="flex-1 flex flex-col md:flex-row">
                    ...
                    <div class="w-full flex-1 mx-2">
                        <x-jet-input wire:model="name" type="text" wire:loading.class="opacity-25" placeholder="Nombre" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
                    </div>
                    <div class="w-full flex-1 mx-2">
            ...
            <div class="flex flex-col md:flex-row border-b border-gray-200 pb-4 mb-4">
                ...
                <div class="flex-1 flex flex-col md:flex-row">
                    <div class="w-full flex-1 mx-2">
                        <x-jet-input wire:model.defer="jobPosition" wire:loading.class="opacity-25" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" placeholder="Cargo"></x-jet-input>
                    </div>
                    <div class="w-full flex-1 mx-2">
                        <x-jet-input wire:model="salary" wire:loading.class="opacity-25" placeholder="Salario" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"></x-jet-input>
                    </div>
                </div>
            </div>
            <div class="flex justify-end flex-col md:flex-row">
                <x-jet-button wire:click="saveNewPersonal" wire:loading.class="animate-pulse" class="text-sm  mx-2 w-32  focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer
                        ...
                        <x-jet-datatable id="personalsTable">
                            ...
                            <x-slot name="tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-jet-button @click="showForm = true" wire:click="updateViewPersonal({{ $personal->id }})" class="px-2 mb-2 py-2 rounded-full text-gray-500 bg-gray-200 font-semibold text-sm flex align-center w-max cursor-pointer active:bg-gray-900 transition duration-300 ease">
                                            Editar</x-jet-button><br>
                                        <x-jet-button wire:click="deletePersonal({{ $personal->id }})" class="px-2 mb-2 py-2 rounded-full text-gray-500 bg-red-200 font-semibold text-sm flex align-center w-max cursor-pointer active:bg-red-900 transition duration-300 ease">
